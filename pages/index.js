  ...
  return (
    <>
      <div className="home-container1">
        <Head>
          <title>Oleksii Kalinin | Low-Code & No-Code Developer</title>
          <meta
            name="description"
            content="Low-Code/No-Code developer. I rapidly build and launch custom websites, landing pages, and web applications"
          />
          <meta
            property="og:title"
            content="Oleksii Kalinin | Low-Code &amp; No-Code Developer"
          />
          <meta
